...
class EvidenceCourtSmokeScriptTest(unittest.TestCase):
    ...
    def test_current_proof_status_and_review_issue_draft_do_not_overclaim_remote_evidence(self) -> None:
        ...
        self.assertIn("Remote CI evidence is confirmed for current main proof anchor commit `6d9bafe`", proof_status)
        self.assertIn("not an automatically updated status page", proof_status)
        self.assertIn("actions/runs/26952138422", proof_status)
        self.assertIn("completed successfully", proof_status)
        self.assertIn("sha256:42f38ea0acc3033479d0588dd33cf4c2f3eceb95b78d2f52a3a81278bae17db1", proof_status)
        self.assertIn("does not automatically prove the latest main commit after `6d9bafe`", proof_status)

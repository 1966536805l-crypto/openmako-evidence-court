...
class EvidenceCourtSmokeScriptTest(unittest.TestCase):
    ...
    def test_current_proof_status_and_review_issue_draft_do_not_overclaim_remote_evidence(self) -> None:
        ...
        self.assertIn("Remote CI evidence is confirmed for current main proof anchor commit `8522392`", proof_status)
        self.assertIn("not an automatically updated status page", proof_status)
        self.assertIn("actions/runs/26955358315", proof_status)
        self.assertIn("completed successfully", proof_status)
        self.assertIn("sha256:cba645e3fcc7f360b43d997340fcce1563d13b4c9211d527d57d45adee435d60", proof_status)
        self.assertIn("does not automatically prove the latest main commit after `8522392`", proof_status)

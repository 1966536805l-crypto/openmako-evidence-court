...
class EvidenceCourtSmokeScriptTest(unittest.TestCase):
    ...
    def test_current_proof_status_and_review_issue_draft_do_not_overclaim_remote_evidence(self) -> None:
        ...
        self.assertIn("Remote CI evidence is confirmed for current main proof anchor commit `6b3f44e`", proof_status)
        self.assertIn("not an automatically updated status page", proof_status)
        self.assertIn("actions/runs/26957166830", proof_status)
        self.assertIn("completed successfully", proof_status)
        self.assertIn("sha256:a2f65c9bec8947c249bfdc276818152fd101caf1d8c1500aa277425a9d6bb780", proof_status)
        self.assertIn("does not automatically prove the latest main commit after `6b3f44e`", proof_status)

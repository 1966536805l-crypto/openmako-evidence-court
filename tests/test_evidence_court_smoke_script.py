...
class EvidenceCourtSmokeScriptTest(unittest.TestCase):
    ...
    def test_outreach_templates_are_review_first_and_bounded(self) -> None:
        ...
        self.assertIn("I am testing a small evidence checker for coding-agent runs.", outreach)
        self.assertIn("The failure case is simple", outreach)
        self.assertIn("I made a bad-run demo around that exact case", outreach)
        self.assertIn("missing a more important evidence field?", outreach)
        ...
        self.assertIn("not ingest native Claude/Codex/Cursor/CI logs yet", outreach)

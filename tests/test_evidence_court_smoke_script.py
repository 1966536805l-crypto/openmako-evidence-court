...
class EvidenceCourtSmokeScriptTest(unittest.TestCase):
    ...
    def test_current_proof_status_and_review_issue_draft_do_not_overclaim_remote_evidence(self) -> None:
        ...
        self.assertIn("Remote CI evidence is confirmed for current main proof anchor commit `bec43ca`", proof_status)
        self.assertIn("not an automatically updated status page", proof_status)
        self.assertIn("actions/runs/26954112264", proof_status)
        self.assertIn("completed successfully", proof_status)
        self.assertIn("sha256:e14168486f74639e0dcb296fab3fa313f7b242f653ebffc4f140e2159afa146f", proof_status)
        self.assertIn("does not automatically prove the latest main commit after `bec43ca`", proof_status)
